...
(function () {
  ...
  function fetchEvents(days) {
    var url = SUPABASE_URL + "/rest/v1/analytics_events?select=event_type,created_at,session_id,visitor_id,listing_slug,listing_name,city,query,path"
  ...
  function startPollingFallback() {
    ...
    setInterval(function () {
      var url = SUPABASE_URL + "/rest/v1/analytics_events?select=event_type,created_at,listing_name,path&created_at=gt." + encodeURIComponent(lastSeen) + "&order=created_at.asc&limit=50";
