...
from blog_content import BLOG_POSTS, BLOG_CTA, BLOG_CTA_DEFAULT
...
<section id="home-about">
  <div class="container">
    <div class="home-about-copy">
      <p>Serving Atlanta and surrounding communities, ATL Bounce House Rentals maintains the highest quality of party and special event rental equipment. We continue to add new items to our rental inventory so if there is something you do not see be sure to ask us about it. For a free quote, please browse through our extensive online catalog and submit a quote request from our website. You can also call or e-mail us and one of our event specialists will be happy to answer all your questions on our event/party rentals.</p>
      <p>ATL Bounce House Rentals has tables, chairs, chair covers, linens, table skirts, dinnerware, flatware, glassware, catering &amp; buffet equipment, bar &amp; beverage equipment, wedding accessories, media &amp; conference equipment, dance floors, staging, platforms, games, elegant accessories, decor and tent rentals. We offer many styles and sizes to fit your needs.</p>
      <p><strong>Submit a request for a quote or call us today &mdash; we are here to help you with all your special event rental needs!</strong></p>
      <div class="hero-ctas" style="margin-top:18px;">
        <a class="btn" href="/products/">Browse Our Catalog &rsaquo;</a>
...
PRODUCTS = [
    ...
    {
        "slug": "portable-folding-bar-table-black-marble",
        "parent_slug": "portable-bar-rentals",
        "parent_name": "Portable Bar Rentals Atlanta",
        "products_only": True,
        "name": "Portable Folding Bar Table - Black Marble",
        "short_name": "Black Marble Portable Bar",
        "category": "Portable Bar Equipment",
        "price": 95.00,
        "unit": "bar table",
        ...
        "image": "/images/products/portable-folding-bar-table-black-marble.jpg",
        "image_alt": "Black marble laminate portable folding bar table, available to rent in Atlanta, Georgia",
        "image_w": 640, "image_h": 655,
        "options": [],
        "specs": [
            ("Height", '42"H (3\' 6")'),
            ("Width", '48"W (4\')'),
        ...
        "description": (
            "Our Portable Folding Bar Table brings a black marble laminate finish and a fully "
            "collapsible frame, ready to set up anywhere in minutes and fold flat for compact storage "
            "when it's not in use. Two work surfaces give a bartender room for both prep and "
            "presentation, making it a natural fit for hotels, conventions, conferences, weddings and "
            "outdoor events."
        ),
    },
    {
...
# ----------------------------------------------------------------- blog
# Post content and per-post CTA cards live in blog_content.py (imported at
# the top of this file) so this generator stays readable as the catalogue
# of guides grows.
def blog_href(post):
